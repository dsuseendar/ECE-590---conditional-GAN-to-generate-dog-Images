...
def load_inception_net(parallel=False):
  inception_model = inception_v3(pretrained=True, transform_input=False) #if pretrained == True, load pretrained from ImageNet
...
def prepare_inception_metrics(base_root,dataset, parallel, no_fid=False):
